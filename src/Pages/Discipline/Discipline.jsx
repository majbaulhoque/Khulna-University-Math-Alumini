...
const Discipline = () => {
    ...
    return (
        <div>
            ...
            <div className="my-3">
                <h1 className="text-center fw-bolder pb-3">Faculty Members</h1>
                {
                ...
                <div className="row">
                    {
                        facultiesData?.map(faculty => {
                            ...
                            return (
                                <div key={id} className="col-12 col-md-6 col-lg-3 gy-lg-5">
                                    <Card className='faculty-card p-3 bg-info m-5 m-lg-4' style={{ width: '20rem' }}>
                                        <Link to={`/faculty/${id}`}>
