...

                            {
                                facultys?.map(faculty => (
                                    <div key={faculty.id} className="col-12 col-md-6 col-lg-3 gy-3">
                                        <div className="card p-3 bg-dark " style={{height: "460px"}}>
                                            <img src={faculty.img} alt="" className="rounded-top" />
